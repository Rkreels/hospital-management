...
import { usePermission, useRole } from "@/lib/role-context";
...
const generatePDFReport = async (type: string, data: unknown) => {
  ...
  switch (type) {
    ...
    case 'dashboard': {
      const { stats, departments, medications } = data as { stats: DashboardStats; departments: Department[]; medications: Medication[] };
      const doc = new jsPDF();
...
export default function ReportsPage() {
  ...
  const fetchReportData = useCallback(async () => {
    ...
    try {
      ...
      const medicationsData: Medication[] = await medicationsRes.json();
      const labOrdersData: LabOrder[] = await labOrdersRes.json();
